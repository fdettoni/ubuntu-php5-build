...
RUN mkdir -p /opt/newrelic && \
    cd /opt/newrelic && \
    wget http://download.newrelic.com/php_agent/release/newrelic-php5-9.6.0.255-linux.tar.gz  -O newrelic-php5-linux.tar.gz &&\
    tar -zxvf newrelic-php5-linux.tar.gz  && \
    rm newrelic-php5-linux.tar.gz && \
    cd /opt/newrelic/newrelic-php5-9.6.0.255-linux/ && \
